...
bot = Bot(token="5459967628:AAETxhsqUv7xJ6QzY_B5Iq8hcditzQ_dy_A")
dp = Dispatcher(bot)
...
async def text(message: types.Message):
    ...
    await bot.send_photo(message.chat.id, photo=photo, caption=f'Ссылка на статью: <a href="{url}">клик</a>',
                         parse_mode="HTML")
